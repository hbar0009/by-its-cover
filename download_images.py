# This file was taken from https://github.com/uchidalab/book-dataset/blob/master/scripts/download_images.py
# It was provided with the book cover dataset to make downloading images in the dataset easier
